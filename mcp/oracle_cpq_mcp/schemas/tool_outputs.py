...
TOOL_OUTPUT_SCHEMAS: dict[str, dict[str, Any] | None] = {
    ...
    "start_bml_site_export": _READ_OUTPUT_SCHEMA,
    "search_local_bml": _READ_OUTPUT_SCHEMA,
    "get_local_job": _READ_OUTPUT_SCHEMA,
    ...
    "list_product_hierarchy_table": _READ_OUTPUT_SCHEMA,
    ...
    "list_commerce_processes_table": _READ_OUTPUT_SCHEMA,
    ...
    "create_transaction": _WRITE_OUTPUT_SCHEMA,
    "new_transaction": _WRITE_OUTPUT_SCHEMA,
    "add_from_favorites": _WRITE_OUTPUT_SCHEMA,
    "display_transaction_history": _WRITE_OUTPUT_SCHEMA,
    "save_transaction": _WRITE_OUTPUT_SCHEMA,
    "save_transaction_version": _WRITE_OUTPUT_SCHEMA,
    "submit_transaction": _WRITE_OUTPUT_SCHEMA,
    "reconfigure_transaction": _WRITE_OUTPUT_SCHEMA,
    "create_transaction_version": _WRITE_OUTPUT_SCHEMA,
    "add_transaction_lines": _WRITE_OUTPUT_SCHEMA,
    "update_transaction_lines": _WRITE_OUTPUT_SCHEMA,
    "remove_transaction_lines": _WRITE_OUTPUT_SCHEMA,
    "delete_transaction_line": _WRITE_OUTPUT_SCHEMA,
    "interact_transaction_line": _WRITE_OUTPUT_SCHEMA,
    "reconfigure_transaction_line": _WRITE_OUTPUT_SCHEMA,
    "reconfigure_transaction_line_inbound": _WRITE_OUTPUT_SCHEMA,
    "list_performance_logs": _READ_OUTPUT_SCHEMA,
    "get_performance_log": _READ_OUTPUT_SCHEMA,
    "export_performance_logs": None,
    "list_metrics": _READ_OUTPUT_SCHEMA,
    "get_collab_operation_queue": _READ_OUTPUT_SCHEMA,
    "clear_collab_operation_queue": _WRITE_OUTPUT_SCHEMA,
    "get_commerce_ui_settings": _READ_OUTPUT_SCHEMA,
    "list_saved_searches": _READ_OUTPUT_SCHEMA,
    "get_saved_search": _READ_OUTPUT_SCHEMA,
